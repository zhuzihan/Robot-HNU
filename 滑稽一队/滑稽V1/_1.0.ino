...
{
  if(frontDis() < 30) flagFB = 1; //change direction to forward
  else if(postDis()<30) flagFB = 0; //change direction to backward
}
int compassRead()
{
...
{
    flagFB = 0;
    if (colorReco(F4) == WHITE&&colorReco(F5) == WHITE) RUN(140, 140);
    else if (colorReco(F4) == WHITE) RUN(100, 140);
    else if (colorReco(F5) == WHITE) RUN(140, 100);
    else if (colorReco(F3) == WHITE&&colorReco(F4) == WHITE) RUN(-40, 140);
    else if (colorReco(F5) == WHITE&&colorReco(F6) == WHITE) RUN(140, -40);
    else if (colorReco(F3) == WHITE) RUN(-30, 80);
    else if (colorReco(F6) == WHITE) RUN(80, -30);
    else if (colorReco(F2) == WHITE&&colorReco(F3) == WHITE) RUN(-40, 80);
    else if (colorReco(F6) == WHITE&&colorReco(F7) == WHITE) RUN(80, -40);
    else if (colorReco(F2) == WHITE) { RUN(-80, 80); wait(50); }
    else if (colorReco(F7) == WHITE) { RUN(80, -80); wait(50); }
    else if (colorReco(F1) == WHITE) { RUN(-80, 80); wait(50); }
    else if (colorReco(F8) == WHITE) { RUN(80, -80); wait(50); }
    else RUN(80,80);
}
void lineWalkingRev()/**reverse line-tracking**/
{
