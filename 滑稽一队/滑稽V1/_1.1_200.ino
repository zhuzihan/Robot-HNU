...
{
    //FlagFB = 0;
    if (colorReco(F5) == WHITE || colorReco(F4) == WHITE) RUNB(250, 250);
    else if (colorReco(F6) == WHITE) RUNB(-100, 250);
    else if (colorReco(F3) == WHITE) RUNB(250, -100);
    ...
    else if (colorReco(F5) == WHITE&&colorReco(F4) == WHITE) RUNB(-50, 250);
    else if (colorReco(F3) == WHITE&&colorReco(F6) == WHITE) RUNB(250, -50);
    else if (colorReco(F6) == WHITE&&colorReco(F3) == WHITE) RUNB(-50, 250);
    else if (colorReco(F2) == WHITE&&colorReco(F7) == WHITE) RUNB(250, -50);
    else RUNB(250,250);
}
