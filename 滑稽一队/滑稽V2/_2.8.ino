...
void bridgeWalking()
{
    if (BLDis() < 550 && BRDis() > 550) {RUN(140, 60);wait(20);}
    else if (BLDis() > 550 && BRDis() < 550) {RUN(60, 140);wait(20);}
    else RUN(60,60);
}
...
//    else RUN(70,70);
//}
//void bridgeWalking(int initAngle)/**Forward line-tracking **/
//{
//    int secondAngle = getAngle();
//    if (initAngle - secondAngle > 5)
//    {
//        Serial.print("secondAngle: ");
//        Serial.println(secondAngle);
//        RUN(200,-200);
//        wait(70);
//    }else if(initAngle - secondAngle < -5)
//    {
//        Serial.print("secondAngle: ");
//        Serial.println(secondAngle);
//        RUN(-200,200);
...
{
  float headingRadians = atan2((double)((*y)-(-146)),(double)((*x)-(-39)));
...
/**回家**/
    ...
    {
        RUN(240,240);
        if( colorReco(G1)==WHITE && colorReco(G2)==WHITE && colorReco(G3)==WHITE && colorReco(G4)==WHITE && colorReco(G5)==WHITE && colorReco(G6)==WHITE && colorReco(G7)==WHITE && colorReco(G8)==WHITE)
        {
            RUN(-200,-200);
            wait(100);
            break;
